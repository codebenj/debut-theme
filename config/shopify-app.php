...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Debutify'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '127c2b142d6084a8ef136a1d0658fd0d'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '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'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_themes,write_themes'),//read_products,write_products
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'themes/delete'),
            'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', '')
        ],
        [
            'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'themes/update'),
            'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', '')
        ],
        [
            'topic' => env('SHOPIFY_WEBHOOK_4_TOPIC', 'themes/create'),
    ...
    */
    ...
    'after_authenticate_job' => [
            ...
            [
                ...
                'inline' => env('AFTER_AUTHENTICATE_JOB_INLINE', true) // False = execute inline, true = dispatch job for later
            ],
    ],
    /*
    |--------------------------------------------------------------------------
