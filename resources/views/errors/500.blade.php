...
<section class="py-5">
    <div class='container text-center'>
      <div class="responsive-container-20by10 mb-4 mb-md-0">
        <img class='lazyload img-fluid' style="width:100%;max-width: 50%;margin:0 auto;right:0;" data-src="/images/500.svg?v={{config('image_version.version')}}">
      </div>
        <h1 class="font-weight-bolder mb-4">Error 500: Internal server error</h1>
        <p class="mb-5">
