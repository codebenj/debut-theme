...
@section('announcement')
    <!-- Announcement bar -->
    <div class="announcement-bar py-2 bg-gradient text-white">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center font-weight-bold">
                    ✨ Debutify is the
                    <a href="javascript:void(0)" class="text-white d-inline download-cta" data-cta-tracking='cta-1'
                       data-toggle="modal" data-target="#downloadModal">Best High-Converting Shopify theme of {{ now()->year }}!</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="homepage">
            ...
            <div class="row align-items-center">
              <div class="col-lg-7 mb-3 mb-lg-0">
                <div class="embed-responsive embed-responsive-16by9 mb-3">
                  <iframe id="jyADqBzVkHQ" class="embed-responsive-item lazyload" width="560" height="315" data-src="" src="" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="card">
                  <div class="card-body">
                    <div class="row text-center">
                      <div class="col">
                        ...
                        <p class="small mb-0">28 conversion hack Add-Ons to get more sales</p>
                      </div>
                      <div class="col">
              ...
              <div class="col-lg-5 text-center">
                ...
                @include ("components.download-wrapper", ['cta_tracking' => 'cta-4'])
              </div>
            </div>
    ...
    <section class="dropshipping-section section">
        <div class="container">
            ...
            <div class="row">
                <div class="col text-center">
                    @include ("components.download-wrapper", ['cta_tracking' => 'cta-6'])
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-addons section bg-gradient text-white">
      <div class="container text-center">
        ...
        <div class="row mb-3">
            <div class="col">
                @include ("components.download-wrapper", ['cta_tracking' => 'cta-7'])
            </div>
        </div>
      </div>
    </section>
    ...
    <div class="angle-wrapper">
                ...
                <div class="row mb-3">
                    <div class="col">
                      <div class="embed-responsive embed-responsive-16by9">
                        <iframe id="vO13Xm1Fmn8" class="embed-responsive-item lazyload" width="560" height="315" data-src="" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                      </div>
                    </div>
                </div>
                <div class="row mb-3">
        ...
        <section class="entrepreneur-section section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        @include ("components.download-wrapper", ['cta_tracking' => 'cta-8'])
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="angle-wrapper">
        ...
        <section id="stickyAddToCart" class="featured-addon-section section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col text-center">
                        @include ("components.download-wrapper", ['cta_tracking' => 'cta-9'])
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="newsletter" class="featured-addon-section section">
          <div class="container">
              ...
              <div class="row">
                  <div class="col text-center">
                      @include ("components.download-wrapper", ['cta_tracking' => 'cta-10'])
                  </div>
              </div>
          </div>
        </section>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="https://gtmetrix.com/reports/dbtfy-test-5.myshopify.com/dOBg9wmQ/" target="_blank">
                                <img class="img-fluid mb-3 rounded lazyload" data-src="images/debutify-gtmetrix-2021.png" alt="gtmetrix result">
                                <img class="img-fluid mb-3 rounded lazyload" data-src="images/gtmetrix-speed-2021.png" alt="gtmetrix result">
                            </a>
                            <p class="store-url">
                              <a href="https://dbtfy-test-5.myshopify.com/collections/all" target="_blank">dbtfy-test-5.myshopify.com/collections/all</a>
                            </p>
    ...
    <div class="angle-wrapper">
      ...
      <section id="productTabs" class="featured-addon-section section">
          <div class="container">
              ...
              <div class="row">
                  <div class="col text-center">
                      @include ("components.download-wrapper", ['cta_tracking' => 'cta-11'])
                  </div>
              </div>
          </div>
      </section>
      ...
      <section class="languages-section section">
          ...
          <div class="container">
              ...
              <div class="row">
                  <div class="col">
                      @include ("components.download-wrapper", ['cta_tracking' => 'cta-12'])
                  </div>
              </div>
          </div>
      </section>
      ...
      <section id="trustBadges" class="featured-addon-section section">
        <div class="container">
            ...
            <div class="row">
                <div class="col text-center">
                    @include ("components.download-wrapper", ['cta_tracking' => 'cta-13'])
                </div>
            </div>
        </div>
      </section>
    ...
    <section class="makemoney-section make-money-bg section bg-overlay-image text-white">
      <div class="container">
          ...
          <div class="row">
              <div class="col text-center">
                  @include ("components.download-wrapper", ['cta_tracking' => 'cta-14'])
              </div>
          </div>
      </div>
    </section>
    ...
    <div class="angle-wrapper">
        ...
        <section id="salesPop" class="featured-addon-section section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col text-center">
                        @include ("components.download-wrapper", ['cta_tracking' => 'cta-15'])
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="blueprint-section section">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col text-center">
                        @include ("components.download-wrapper", ['cta_tracking' => 'cta-16'])
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="cartCountdown" class="featured-addon-section section">
          <div class="container">
              ...
              <div class="row">
                  <div class="col text-center">
                      @include ("components.download-wrapper", ['cta_tracking' => 'cta-17'])
                  </div>
              </div>
          </div>
        </section>
    ...
    <section class="product-research-section section bg-gradient text-white">
        <div class="container">
            <div class="row mb-3">
              ...
              <div class="row">
                <div class="col text-center">
                    @include ("components.download-wrapper", ['cta_tracking' => 'cta-18'])
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="angle-wrapper">
        ...
        <section id="upsellBundles" class="featured-addon-section section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col text-center">
                        @include ("components.download-wrapper", ['cta_tracking' => 'cta-19'])
                    </div>
                </div>
            </div>
        </section>
    ...
    <section class="cash-printing-section section bg-overlay-image">
        <div class="container">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <p><strong>28 conversion Add-Ons boost sales</strong></p>
                            </div>
                        </div>
                        <div class="w-100 d-lg-none"></div>
                        <div class="card mb-3">
            ...
            <div class="row text-white">
                <div class="col">
                    @include ("components.download-wrapper", ['cta_tracking' => 'cta-20'])
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="angle-wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        @include ("components.download-wrapper", ['cta_tracking' => 'cta-21'])
                    </div>
                </div>
        ...
        <section class="funnel-section section">
            ...
            <div class="container">
                ...
                @include ("components.download-wrapper", ['cta_tracking' => 'cta-22'])
            </div>
        </section>
        ...
        <section class="save-on-apps-section section">
            <div class="container">
                ...
                @include ("components.download-wrapper", ['cta_tracking' => 'cta-23'])
            </div>
        </section>
    </div>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    @include ("components.download-wrapper", ['cta_tracking' => 'cta-28'])
                </div>
            </div>
        </div>
    </section>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary download-cta" data-cta-tracking="cta-29" data-dismiss="modal" data-toggle="modal" data-target="#downloadModal">
...
<div class="modal fade" tabindex="-1" role="dialog" id="videoModal" aria-labelledby="addonVideo" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary download-cta" data-cta-tracking="cta-30" data-dismiss="modal" data-toggle="modal" data-target="#downloadModal">
            <span class="fas fa-download" aria-hidden="true"></span>
            Free Download Now
        </button>
      </div>
...
<script>
    $(function() {
        ...
        function setVideoFramejyADqBzVkHQ(){
          document.getElementById('jyADqBzVkHQ').src = 'https://www.youtube.com/embed/jyADqBzVkHQ?autoplay=0';
        }

        function setVideoFramevO13Xm1Fmn8(){
          document.getElementById('vO13Xm1Fmn8').src = 'https://www.youtube.com/embed/vO13Xm1Fmn8?autoplay=0';
        }
        ...
        // $(window).bind("load", function() {
          ...
          setTimeout(function() {
              setVideoFramejyADqBzVkHQ();
              setVideoFramevO13Xm1Fmn8();
          }, 1000);
