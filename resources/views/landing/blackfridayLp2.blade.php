            ...
            <div class="row">
                <div class="col-12 text-center font-weight-bold">
                    ...
                    <a href="javascript:void(0)" class="text-white d-inline download-cta" data-cta-tracking='cta-1'
                       data-toggle="modal" data-target="#downloadModal">Get 50% for the first 3 months on ALL plans

                        <div id="clockdiv">
                            <div>
                                &nbsp; - &nbsp; <span id="black_sale_countdown_days" class="days"></span> :
                            </div>
                            <div>
                                <span id="black_sale_countdown_hours" class="hours"></span> :
                            </div>
                            <div>
                                <span id="black_sale_countdown_minutes" class="minutes"></span> :
                            </div>
                            <div>
                                <span id="black_sale_countdown_seconds" class="seconds"></span>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <section class="above-fold-section section">
          <div class="container get-sells-section">
            <div class="row text-center mb-3">
              <div class="col-12">
                <h3 class="">Black Friday Cyber Monday Sale</h3>
                <h3 class="">Your best deal ever! 50% off the first 3 months on ALL plans </h3>
              </div>
            </div>
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 text-center">
                    <p class="lead">+ Get entered to win one of three 1-on-1 mentoring calls with Debutify Founder & 8-figure entrepreneur Ricky Hayes (a $1300 value!)</p>
                    <p class="lead font-weight-bold">Don’t miss out! Download the highest-converting <b> FREE Shopify Theme </b> now.</p>
{{--                    <p>64,897 DOWNLOADS   <img class="lazyload img-fluid" data-src="/images/trustpilot.jpg" width="200" alt="shopify"></p>--}}
...
<script>
    ...
    var countDownDate = new Date().getTime() + 2880000;
    ...
    var x = setInterval(function() {
      ...
      document.getElementById("black_sale_countdown_days").innerHTML = days.toString().padStart(2, "0");
      document.getElementById("black_sale_countdown_hours").innerHTML = hours.toString().padStart(2, "0");
      document.getElementById("black_sale_countdown_minutes").innerHTML = minutes.toString().padStart(2, "0");
      document.getElementById("black_sale_countdown_seconds").innerHTML = seconds.toString().padStart(2, "0");

      // If the count down is finished, write some text
      if (distance < 1000) {
        console.log(distance);
        clearInterval(x);
        document.getElementById("black_sale_countdown_days").innerHTML = '00';
        document.getElementById("black_sale_countdown_hours").innerHTML = '00';
        document.getElementById("black_sale_countdown_minutes").innerHTML = '00';
        document.getElementById("black_sale_countdown_seconds").innerHTML = '00';
      }
    }, 1000);
