          ...
          <div class="Polaris-CalloutCard">
            <div class="Polaris-CalloutCard__Content grid-product-wrapper">
              ...
              <div class="Polaris-CalloutCard__Buttons">
                <button type="button" class="Polaris-Button Polaris-Button--primary Polaris-Button--fullWidth" data-polaris-unstyled="true" onclick='return openProductModal("{{$product->name}}","{{$product->image}}","{{$product->price}}","{{$product->cost}}","{{$product->profit}}","{{$product->aliexpresslink}}","{{$product->facebookadslink}}","{{$product->youtubelink}}","{{$product->competitorlink}}","{{$product->googletrendslink}}","{{$product->age}}","{{$product->gender}}","{{$product->placement}}","{{$product->saturationlevel}}","{{$product->interesttarget}}","{{ $product->opinion }}","{{ $product->description }}","{{$product->video}}");'>
                  <span class="Polaris-Button__Content"><span>View product</span></span>
                </button>
